...
------------------
---- MONITORS ---- !YOU NEED TO CONFIG THIS!
------------------
...
hl.exec_cmd("/usr/lib/polkit-game/polkit-gnome/authentication-agent-1")
hl.exec_cmd("dunst")
hl.exec_cmd("waybar")
...
hl.bind("SUPER + SHIFT + A", hl.dsp.exec_cmd("walker"))
